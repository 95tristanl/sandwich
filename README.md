...
Start the Game:
To start the game everybody participates in a {Battle} (in the app though, the person who creates the room starts the game). After, follow {Order of Play} and {normal play} begins. Higher cards are better to start the game. 

When playing with a 12 card starting hand and after a round you find yourself with 7 cards or less, you {Refuel}. {Refueling} only takes place after the round is over/before the next round. 
...
#2 play a {9} as a {wild} card.
#3 play a card of the same value: this means you initiate a {Battle} or a {Sandwich} if you play multiple cards of the same value of the last card played.
#4 {Fold}
...
Player #1 won the beginning {Battle} or started the online game: he played a queen, player #2 played a 10 and player #3 played a 6 so player #1 starts next round and wins 3 points since card pile consisted of 3 cards. 
