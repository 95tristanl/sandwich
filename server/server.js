...
const setupServer = async () => {
    ...
    try {
        ...
        await mongoose.connect("mongodb://localhost:32770/leveiltt", {useNewUrlParser: true});
        console.log("MongoDB connected: mongodb://localhost:32770/leveiltt"); //kitematic
    } catch (err) {
        //console.log(err);
        process.exit(-1);
    }
